document.addEventListener('DOMContentLoaded', () => {
	...
	gsap.matchMedia().add(breakpoints.smallLaptop, () => {
		gsap.fromTo(
			textKiri,
			{x: -900, y: -150},
			{x: -350, y: 0, duration: 2, delay: 2.3, ease: 'power2.out'}
		);
	});
	...
	gsap.matchMedia().add(breakpoints.tablet, () => {
		gsap.fromTo(
			textKiri,
			{x: -700, y: -100},
			{x: -280, y: 0, duration: 2, delay: 2.3, ease: 'power2.out'}
		);
	});
	...
	gsap.matchMedia().add(breakpoints.largePhone, () => {
		gsap.fromTo(
			textKiri,
			{x: -550, y: -70},
			{x: -200, y: 0, duration: 2, delay: 2.3, ease: 'power2.out'}
		);
	});
	...
	gsap.matchMedia().add(breakpoints.smallPhone, () => {
		gsap.fromTo(
			textKiri,
			{x: -350, y: -80},
			{x: -70, y: -170, duration: 2, delay: 2.3, ease: 'power2.out'}
		);
	});
	...
	gsap.matchMedia().add(breakpoints.smallLaptop, () => {
		gsap.fromTo(waveSvg, {y: '100%'}, {y: -300, duration: 2, delay: 2, ease: 'power2.out'});
	});

	gsap.matchMedia().add(breakpoints.tablet, () => {
		gsap.fromTo(waveSvg, {y: '100%'}, {y: -250, duration: 2, delay: 2, ease: 'power2.out'});
	});
